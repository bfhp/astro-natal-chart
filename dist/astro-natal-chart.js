...
function B(t, n) {
  const { svg: e } = t, s = G(t.planetDots, n);
  for (const i of s) {
    const u = i.name, c = i.angle, o = a(t.cx, t.cy, c, t.planetOrbitRadius), l = document.createElementNS(d, "text"), r = U(t, u, t.aspects);
    l.textContent = V[i.planet], l.setAttribute("x", o.x), l.setAttribute("y", o.y), l.setAttribute("text-anchor", "middle"), l.setAttribute("dominant-baseline", "middle"), l.setAttribute("fill", r), l.setAttribute("font-size", t.size * 0.04);
...
function X(t, n, e) {
  ...
  o.setAttribute("x", c.x), o.setAttribute("y", c.y), o.setAttribute("text-anchor", "middle"), o.setAttribute("dominant-baseline", "middle"), o.setAttribute("font-size", t.size * 0.02), o.setAttribute("fill", t.colors.text), o.textContent = j[e - 1], s.appendChild(o);
}
function F(t) {
...
function W(t) {
  ...
  const x = document.createElementNS(d, "line"), z = a(t.cx, t.cy, u, l - E);
...
class lt {
  ...
  render() {
    ...
    q(this), Z(this), W(this), F(this), K(this), L(this, this.options.planets, n, "A"), this.options.planets2 && L(this, this.options.planets2, n, "B"), this.aspects = P(this.planetDots), B(this, n), h(this, n), J(this), Q(this), tt(this, n);
  }
}
export {
  lt as default
